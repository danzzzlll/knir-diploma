...
![Train Valid Full Acc](images/train_valid_full.jpg)

### Зависимость качества на полных изображениях от качества на фрагментах
![Valid Full Valid Frag](images/valid_valid.jpg)

## Notes:
С нормализацией, без обрезания пикселей и без фильтров, с новым scheduler
Аугментация - соль + перец, размер изображений - 300x300
Качество на полных изображениях - 74.4